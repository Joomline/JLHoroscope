...
<script type="text/javascript">
	Joomla.submitbutton = function (task) {
		if (task == 'horoscope.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<form action="<?php echo JRoute::_( 'index.php?option=com_jlhoroscope&id=' . $this->form->getValue( 'id' ) ); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				...
				<div class="form-vertical">
					...
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel( 'tumbinail' ); ?></div>
						<div class="controls"><?php echo $this->form->getInput( 'tumbinail' ); ?></div>
					</div>
				</div>
			</div>
		</div>
